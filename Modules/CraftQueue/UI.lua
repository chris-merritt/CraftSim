    ...
    local function createContent(frame)
        ...
        queueTab.content.addWorkOrdersOptions = CraftSim.WIDGETS.OptionsButton {
            ...
            menuUtilCallback = function(ownerRegion, rootDescription)
                ...
                local patronOrderExpansions = orderTypeSubMenu:CreateCheckbox(L("CRAFT_QUEUE_PATRON_ORDERS_BUTTON"), function()
                    ...
                    patronOrderExpansions:CreateCheckbox(L("EXPANSION_THE_WAR_WITHIN"), function()
                    return CraftSim.DB.OPTIONS:Get("CRAFTQUEUE_WORK_ORDERS_INCLUDE_PATRON_TWW")
                end, function()
                    local value = CraftSim.DB.OPTIONS:Get("CRAFTQUEUE_WORK_ORDERS_INCLUDE_PATRON_TWW")
                    CraftSim.DB.OPTIONS:Save("CRAFTQUEUE_WORK_ORDERS_INCLUDE_PATRON_TWW", not value)
                end)
                    patronOrderExpansions:CreateCheckbox(L("EXPANSION_MIDNIGHT"), function()
                    return CraftSim.DB.OPTIONS:Get("CRAFTQUEUE_WORK_ORDERS_INCLUDE_PATRON_MIDNIGHT")
                end, function()
                    local value = CraftSim.DB.OPTIONS:Get("CRAFTQUEUE_WORK_ORDERS_INCLUDE_PATRON_MIDNIGHT")
                    CraftSim.DB.OPTIONS:Save("CRAFTQUEUE_WORK_ORDERS_INCLUDE_PATRON_MIDNIGHT", not value)
                end)
